...
def upgrade() -> None:
    ...
    sa.Column('category_type', sa.Enum('minijob', 'freelance', 'commission', 'expenses', name='categorytype'), nullable=False),
    ...
    op.create_table('plannedexpense',
    sa.Column('aprox_date', sa.Date(), nullable=False),
    sa.Column('value', sa.Float(), nullable=False),
    sa.Column('currency', sa.Enum('euro', 'usd', name='currencytype'), nullable=False),
    sa.Column('frequency', sa.Enum('weekly', 'monthly', 'quarterly', 'biannually', 'yearly', 'one_time', name='frequencytype'), nullable=False),
    ...
    sa.Column('value', sa.Float(), nullable=False),
    sa.Column('currency', sa.Enum('euro', 'usd', name='currencytype'), nullable=False),
    sa.Column('payment_method', sa.Enum('cash', 'paypal', 'bank_transfer', name='paymentmethodtype'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
