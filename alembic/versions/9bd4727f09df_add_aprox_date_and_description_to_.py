...
def upgrade() -> None:
    ...
    op.drop_constraint(
        op.f("activitylog_transaction_id_key"), "activitylog", type_="unique"
    )
    op.create_unique_constraint(None, "activitylog", ["movement_id"])
    op.drop_constraint(
        op.f("activitylog_transaction_id_fkey"), "activitylog", type_="foreignkey"
    )
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        op.f("activitylog_transaction_id_fkey"),
        "activitylog",
        "movement",
        ["transaction_id"],
        ["id"],
    ...
    op.create_unique_constraint(
        op.f("activitylog_transaction_id_key"),
        "activitylog",
        ["transaction_id"],
